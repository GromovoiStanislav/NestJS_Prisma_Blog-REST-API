...
export class CategoriesService {
  ...
  async findAll(query?: Prisma.CategoryInclude) {
    return this.prismaService.category.findMany({ include: { ...query, _count: true } });
  }


  async findOne(id: string, query?: Prisma.CategoryInclude) {
    return this.prismaService.category.findUnique({ where: { id }, include: { ...query, _count: true } });
  }
